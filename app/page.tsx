        ...
        {step === "input" && (
          <div className="animate-fade-in-up">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { icon: "🔍", title: "自動スタック検出", desc: "import文からSwift/JS/Pythonの依存関係を自動解析" },
                { icon: "🗺️", title: "アーキテクチャ図", desc: "フロントエンド・バックエンド・DBの構成を視覚化" },
                { icon: "🤖", title: "AIコード解析", desc: "各ファイルの役割・処理をAIがわかりやすく解説" },
              ].map((f) => (
        ...
        {step === "results" && result && (
          <div className="space-y-6 animate-fade-in-up">
            ...
            <ResultsPanel
              ...
              hasCoreFiles={!!(coreFileContents && Object.keys(coreFileContents).length > 0)}
